# homework03
Homework 3 - SpMV using the CSR format

0. READ THE INSTRUCTIONS BELOW COMPLETELY BEFORE PROCEEDING.

1. In this assignment, you will be implementing a sparse matrix-vector multiply function that was described in the lecture.
...
        i. Make sure the code is using a O(N) algorithm. Any code that runs for longer than 10 minutes will be considered non-functional for that data set (there WILL be large matrices in evaluation).
